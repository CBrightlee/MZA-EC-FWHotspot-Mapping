...
testmap = 0;
    % What type of data?
    opt.site='MWR';% Short name or acronym for the site of interest
    opt.L4file='C:\MontezumaData\2024_Data\EC_Data\FW_FluxMaps\L4_Processed\MZA_L4.mat';% The directory of the L4 file
    ...
    opt.HaveMap=1;% Default: 0= I dont have one. 1= Yes, I have a raster with land covers, 
    ...
    opt.start='2024-01-193 00:00'; % format YYYY-01-DOY HH:MM
    opt.end2='2024-01-274 00:00'; % format YYYY-01-DOY HH:MM    %For debugging
    %opt.end2='2024-01-200 24:00'; % format YYYY-01-DOY HH:MM    
 
    opt.FPcontour=[50,80];% Choose Footprint Percentages. no more than 60-70 % for nighttime
    opt.f2h=150; % Fetch to height ratio defines the initial size of grid. varies from 100-150
    ...
    %% Saving options
    opt.SaveDir=(['C:\MontezumaData\2024_Data\EC_Data\FW_FluxMaps\Footprint_Output\continuous\']);
    opt.Sufix='MZA';% A sufix to add to the name of the file
